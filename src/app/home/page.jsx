  ...
  return (
      <div className="font-sans">
        <section className="relative">
          ...
          />
          <div
              className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center text-center text-white bg-black bg-opacity-50">
        ...
        <section className="px-8 py-16 text-center flex flex-col items-center">
          ...
          <p className="max-w-3xl mx-auto text-lg leading-relaxed mt-4">Created by the Autonomous Robotics Club (ARC) in
            partnership with the Institute for Networks, Optimization, and Control (ICON), the Robotics and Intelligent
            Systems Expo (RISE) aims to be on the frontier of showcasing innovation in the fields of robotics and
            autonomy. RISE's primary goal is to immerse attendees in the dynamic world of robotics and AI, showcasing
            the vast opportunities in these domains and igniting interest among students and faculty. This is achieved
            through robotics demonstrations, enlightening presentations, and engaging networking sessions. Hosted at
            Purdue University, RISE will showcase the cutting-edge research and technology developed by the students and
            faculty at one of the top engineering institutions in the country.</p>
        </section>
